...
export const GridBackground = ({ children, isCentered = false }: GridBackgroundProps) => {
    return (
        <div className="relative flex w-full bg-white dark:bg-nord">
            ...
            />
            {/* Faded effect */}
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)] dark:bg-nord"></div>
            <div
                className={cn(
