...
3. Run command to start the DNS server.
```bash
	make run
```

4. Run command to lookup domain using this DNS resolver.
```bash
...
```bash
    ...
    dig google.com -t A
```
<img src="./image/dig_google_A.png" alt="dig output for google.com"/>
...
```
<img src="./image/dig_google_AAAA.png" alt="dig output for google.com"/>
...
<img src="./image/lookup_amazon.png" alt="dig output for google.com"/>

<br/>
Same thing happens for google.com

<img src="./image/lookup_google.png" alt="dig output for google.com"/>

<br/>

### 2. Lookup fake domains
<img src="./image/lookup_fake_domain.png" alt="dig output for google.com"/>
